        ...
        <div className="hidden items-center gap-8 md:flex">
          {links.map((link) => (
            <Link
              key={link.href}
              to={link.href}
              className={`text-md font-medium transition-colors hover:text-green-700 ${
                isActive(link.href)
        ...
        <div className="border-t border-gray-200 md:hidden">
          {links.map((link) => (
            <Link
              ...
              className={`block px-4 py-3 text-md font-medium transition-colors hover:bg-gray-50 hover:text-green-600 ${

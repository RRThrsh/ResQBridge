...
import { RescuerStatusBadge } from '@/components/rescuer/RescuerStatusBadge' // Reusing this badge component for consistency
...
export function DomesticReportCard({ report, variant = 'default' }: Props) {
  ...
  return (
    <Link
      to={`/pwrcc/domestic/reports/${report.id}`}
      className={cn(
    ...
    >
      ...
      <div className="flex min-w-0 flex-1 flex-col justify-center">
        <div className="mb-1.5 flex flex-wrap items-center gap-2">
          {/* We are reusing the existing badge logic since we are passing standard report statuses */}
